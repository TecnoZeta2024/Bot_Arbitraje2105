...
>(({ className, variant = 'default', ...props }, ref) => {
  const variants = {
    ...
    glass: 'backdrop-blur-md bg-background/80 border border-border/50',
    gradient: 'bg-gradient-to-br from-card to-card/80 border',
  }
...
>(({ className, title, value, change, icon, trend = 'neutral', ...props }, ref) => {
  const trendColors = {
    ...
    down: 'text-trading-red',
    neutral: 'text-muted-foreground',
  }

  return (
    <TradingCard ref={ref} className={cn('p-6', className)} {...props}>
